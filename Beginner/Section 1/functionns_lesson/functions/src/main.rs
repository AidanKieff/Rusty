fn main() {
    ...
    // wants me to type as "for element: i32 in a {}" however this does not compile. It seems you can't type annotate 
    // a name you are using for a for loop?? 
}
